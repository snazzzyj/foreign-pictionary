  ...
  rounds: [
    {
      ...
      name: "Innuendo Lingo",
      icon: "🔞",
      tagline: "Innocent foreign words that sound suspicious in English...",
      type: "multichoice",
      questionCount: 8,
    ...
    },
    {
      ...
      name: "Phunny Phrases",
      icon: "🤪",
      tagline: "Bizarre idioms from around the world with quirky literal translations!",
      type: "written-phrase",
      questionCount: 8,
    ...
    },
    {
      ...
      icon: "🌍",
      tagline: "Find yourself in the middle of nowhere!",
    ...
    },
    {
      ...
      icon: "🎨",
      tagline: "Is your drawing a universal language?",
      type: "pictionary",
      questionCount: 12,
  ...
  "round-1": [
    ...
    },
    {
      ...
      options: [
        ...
        { key: "C", text: "Sunset", isCorrect: false }
      ],
    ...
    },
    {
      ...
      sentence: "He calls me बीच बीच में.",
